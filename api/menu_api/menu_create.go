...
type MenuRequest struct {
	...
	AbstractTime  int         `json:"abstract_time" structs:"abstract_time"`                //切换的时间，秒
	BannerTime    int         `json:"banner_time" structs:"banner_time"`                    //切换的时间，秒
	Sort          int         `json:"sort" binding:"required" msg:"请输入菜单序号" structs:"sort"` //菜单的序号
	ImageSortList []ImageSort `json:"image_sort_list" struct:"-"`                           //具体图片的顺序
}
